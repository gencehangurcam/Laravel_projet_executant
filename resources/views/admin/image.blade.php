            ...
            <div class="flex flex-wrap lg:justify-between">
                    ...
                    <div class="bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                        <div class="mb-8">
                            ...
                            <img class="object-center object-cover h-36 w-36"
                                ...
                                <h1 class="text-white">{{ $image->categorie->name }}</h1>
                ...
                <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                    <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                        <form class="w-full max-w-sm" method="POST" action="{{ route("image.store") }}" enctype="multipart/form-data">
                        @csrf
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                <p>categorie
                                <select name="categorie_id" type="string"
                                    class="
                             w-full
                             rounded
                             py-3
